...
# a handful of strings and in nothing else. Each of the three editors carries one
...
# its own. **It depends on the three editors, which makes it the way to install
...
# editors are absent is a command that can only apologise.
#
